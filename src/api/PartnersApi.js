...
export default class PartnersApi {
    ...
    */
    ...
    /**
     * Callback function to receive the result of the putOrdersIdShip operation.
     * @callback module:api/PartnersApi~putOrdersIdShipCallback
     ...
     * @param {module:api/PartnersApi~putOrdersIdShipCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/Paths1orderspostresponses201contentapplication1jsonschema}
     */
    putOrdersIdShip(body, id, callback) {
      let postBody = body;
    ...
    /**
     * Callback function to receive the result of the putOrdersIdStatus operation.
     * @callback module:api/PartnersApi~putOrdersIdStatusCallback
     * @param {String} error Error message, if any.
     * @param {module:model/Paths1orderspostresponses201contentapplication1jsonschema} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * Update Order Status
     * Note, this API is used to update orders and is reserved for our shipping partners.
     * @param {module:api/PartnersApi~putOrdersIdStatusCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/Paths1orderspostresponses201contentapplication1jsonschema}
     */
    putOrdersIdStatus(body, id, callback) {
      let postBody = body;
