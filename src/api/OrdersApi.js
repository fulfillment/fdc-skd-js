...
import Paths1ordersgetresponses200contentapplication1jsonschema from '../model/Paths1ordersgetresponses200contentapplication1jsonschema';
import Paths1ordersgetresponses404contentapplication1jsonschema from '../model/Paths1ordersgetresponses404contentapplication1jsonschema';
import Paths1orderspostresponses201contentapplication1jsonschema from '../model/Paths1orderspostresponses201contentapplication1jsonschema';
...
export default class OrdersApi {
    ...
    */
    ...
    /**
     * Callback function to receive the result of the deleteOrdersId operation.
     * @callback module:api/OrdersApi~deleteOrdersIdCallback
     * @param {String} error Error message, if any.
     * @param {module:model/Paths1orderspostresponses201contentapplication1jsonschema} data The data returned by the service call.
     ...
     * @param {module:api/OrdersApi~deleteOrdersIdCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/Paths1orderspostresponses201contentapplication1jsonschema}
     */
    deleteOrdersId(id, callback) {
      let postBody = null;
      ...
      let authNames = ['fdcAuth'];
      let contentTypes = [];
      let accepts = ['application/json'];
      let returnType = Paths1orderspostresponses201contentapplication1jsonschema;
     ...
     * @param {String} error Error message, if any.
     * @param {module:model/Paths1ordersgetresponses200contentapplication1jsonschema} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * data is of type: {@link module:model/Paths1ordersgetresponses200contentapplication1jsonschema}
     */
    getOrder(id, opts, callback) {
      ...
      let queryParams = {
        ...
        'hydrate': this.apiClient.buildCollectionParam(opts['hydrate'], 'csv')
      };
      let headerParams = {
      };
      let formParams = {
      ...
      let contentTypes = [];
      let accepts = ['application/json'];
      let returnType = Paths1ordersgetresponses200contentapplication1jsonschema;
     ...
     * @param {String} error Error message, if any.
     * @param {module:model/OrderResponseOneOfV2} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * data is of type: {@link module:model/OrderResponseOneOfV2}
     */
    getOrders(fromDate, toDate, opts, callback) {
      opts = opts || {};
      let postBody = null;
      ...
      let queryParams = {
        'fromDate': fromDate,
        'toDate': toDate,
        'merchantIds': this.apiClient.buildCollectionParam(opts['merchantIds'], 'csv'),
        'warehouseIds': this.apiClient.buildCollectionParam(opts['warehouseIds'], 'csv'),
        'page': opts['page'],
        'limit': opts['limit'],
        'hydrate': this.apiClient.buildCollectionParam(opts['hydrate'], 'csv')
      };
      ...
      let contentTypes = [];
      let accepts = ['application/json'];
      let returnType = OrderResponseOneOfV2;
     ...
     * @param {String} error Error message, if any.
     * @param {module:model/OrderResponseV2} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * data is of type: {@link module:model/OrderResponseV2}
     */
    postOrders(body, callback) {
      let postBody = body;
      ...
      let accepts = ['application/json'];
      let returnType = OrderResponseV2;
