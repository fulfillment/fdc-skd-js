...
export default class InventoryApi {
    ...
    */
     ...
     * @param {module:model/ItemInventoryArrayV2} data The data returned by the service call.
     ...
     * data is of type: {@link module:model/ItemInventoryArrayV2}
     */
    getInventory(opts, callback) {
      opts = opts || {};
      let postBody = null;
      ...
      let queryParams = {
        ...
        'externalSkuNames': this.apiClient.buildCollectionParam(opts['externalSkuNames'], 'csv')
      };
      let headerParams = {
      };
      let formParams = {
      ...
      let returnType = ItemInventoryArrayV2;
