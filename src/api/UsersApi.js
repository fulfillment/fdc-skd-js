...
export default class UsersApi {
    ...
    */
     ...
     * @param {module:model/UserContactV2} data The data returned by the service call.
     ...
     * data is of type: {@link module:model/UserContactV2}
     */
    getUsersMe(callback) {
      let postBody = null;
