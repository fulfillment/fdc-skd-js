...
import Paths1returnsgetresponses200contentapplication1jsonschemapropertiesdataitemspropertiesupdatedBy from './Paths1returnsgetresponses200contentapplication1jsonschemapropertiesdataitemspropertiesupdatedBy';
import ReturnsArrayV2Order from './ReturnsArrayV2Order';
import ReturnsArrayV2Status from './ReturnsArrayV2Status';
...
export default class ReturnV2 {
    ...
    * @param createdBy {module:model/Paths1returnsgetresponses200contentapplication1jsonschemapropertiesdataitemspropertiesupdatedBy} 
    * @param status {module:model/ReturnsArrayV2Status} 
    * @param reason {module:model/ReturnsArrayV2Status} 
    * @param createdAt {Date} 
    * @param updatedAt {Date} 
    */

    constructor(id, updatedBy, createdBy, status, reason, createdAt, updatedAt) {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('order')) {
                obj['order'] = ReturnsArrayV2Order.constructFromObject(data['order']);
            }
            if (data.hasOwnProperty('updatedBy')) {
                obj['updatedBy'] = UserV2.constructFromObject(data['updatedBy']);
            }
            if (data.hasOwnProperty('createdBy')) {
                obj['createdBy'] = Paths1returnsgetresponses200contentapplication1jsonschemapropertiesdataitemspropertiesupdatedBy.constructFromObject(data['createdBy']);
            }
            if (data.hasOwnProperty('status')) {
                obj['status'] = ReturnsArrayV2Status.constructFromObject(data['status']);
            }
            if (data.hasOwnProperty('reason')) {
                obj['reason'] = ReturnsArrayV2Status.constructFromObject(data['reason']);
            }
    ...
    */
    'rmaItems' = undefined;
    /**
    * @member {module:model/ReturnsArrayV2Order} order
    */
    'order' = undefined;
    /**
    ...
    */
    'updatedBy' = undefined;
    /**
    * @member {module:model/Paths1returnsgetresponses200contentapplication1jsonschemapropertiesdataitemspropertiesupdatedBy} createdBy
    */
    'createdBy' = undefined;
    /**
    * @member {module:model/ReturnsArrayV2Status} status
    */
    'status' = undefined;
    /**
    * @member {module:model/ReturnsArrayV2Status} reason
    */
    'reason' = undefined;
    /**
