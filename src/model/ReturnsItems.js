...
/**
* The ReturnsItems model module.
* @module model/ReturnsItems
* @version 2.0
*/
export default class ReturnsItems {
    /**
    * Constructs a new <code>ReturnsItems</code>.
    * @alias module:model/ReturnsItems
    * @class
    * @param sku {String} 
    * @param quantityExpected {Number} 
    */

    constructor(sku, quantityExpected) {
    ...
    /**
    * Constructs a <code>ReturnsItems</code> from a plain JavaScript object, optionally creating a new instance.
    * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
    * @param {Object} data The plain JavaScript object bearing properties of interest.
    * @param {module:model/ReturnsItems} obj Optional instance to populate.
    * @return {module:model/ReturnsItems} The populated <code>ReturnsItems</code> instance.
    */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ReturnsItems();
