...
/**
* The OneOfGeometryCoordinates model module.
* @module model/OneOfGeometryCoordinates
* @version 2.0
*/
export default class OneOfGeometryCoordinates {
    /**
    * Constructs a new <code>OneOfGeometryCoordinates</code>.
    * @alias module:model/OneOfGeometryCoordinates
    * @class
    */
    ...
    /**
    * Constructs a <code>OneOfGeometryCoordinates</code> from a plain JavaScript object, optionally creating a new instance.
    * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
    * @param {Object} data The plain JavaScript object bearing properties of interest.
    * @param {module:model/OneOfGeometryCoordinates} obj Optional instance to populate.
    * @return {module:model/OneOfGeometryCoordinates} The populated <code>OneOfGeometryCoordinates</code> instance.
    */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new OneOfGeometryCoordinates();
