...
/**
* The ConsigneeV21 model module.
* @module model/ConsigneeV21
* @version 2.0
*/
export default class ConsigneeV21 {
    /**
    * Constructs a new <code>ConsigneeV21</code>.
    * @alias module:model/ConsigneeV21
    * @class
    * @param id {Number} 
    ...
    */
    ...
    constructor(id, country, postalCode, addressRegion, addressLocality, address1, lastName, firstName) {
    ...
    /**
    * Constructs a <code>ConsigneeV21</code> from a plain JavaScript object, optionally creating a new instance.
    * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
    * @param {Object} data The plain JavaScript object bearing properties of interest.
    * @param {module:model/ConsigneeV21} obj Optional instance to populate.
    * @return {module:model/ConsigneeV21} The populated <code>ConsigneeV21</code> instance.
    */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ConsigneeV21();
            ...
            if (data.hasOwnProperty('updatedBy')) {
                obj['updatedBy'] = Paths1returnsgetresponses200contentapplication1jsonschemapropertiesdataitemspropertiesupdatedBy.constructFromObject(data['updatedBy']);
            }
    ...
    */
    'id' = undefined;
    /**
    * @member {module:model/Paths1returnsgetresponses200contentapplication1jsonschemapropertiesdataitemspropertiesupdatedBy} updatedBy
    */
    'updatedBy' = undefined;
    /**
