...
/**
* The OrdersidstatusStatus model module.
* @module model/OrdersidstatusStatus
* @version 2.0
*/
export default class OrdersidstatusStatus {
    /**
    * Constructs a new <code>OrdersidstatusStatus</code>.
    * @alias module:model/OrdersidstatusStatus
    * @class
    * @param code {String} 
    */
    ...
    /**
    * Constructs a <code>OrdersidstatusStatus</code> from a plain JavaScript object, optionally creating a new instance.
    * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
    * @param {Object} data The plain JavaScript object bearing properties of interest.
    * @param {module:model/OrdersidstatusStatus} obj Optional instance to populate.
    * @return {module:model/OrdersidstatusStatus} The populated <code>OrdersidstatusStatus</code> instance.
    */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new OrdersidstatusStatus();
