...
import StatusTypeV2ActionRequiredBy from './StatusTypeV2ActionRequiredBy';
import StatusTypeV2Stage from './StatusTypeV2Stage';

/**
* The StatusTypeV2 model module.
* @module model/StatusTypeV2
* @version 2.0
*/
export default class StatusTypeV2 {
    /**
    * Constructs a new <code>StatusTypeV2</code>.
    * @alias module:model/StatusTypeV2
    * @class
    * @param stage {module:model/StatusTypeV2Stage} 
    * @param state {module:model/StatusTypeV2Stage} 
    * @param detailCode {String} 
    * @param code {String} Code, see [status codes](#section/Getting-Started/Status-Codes)
    */

    constructor(stage, state, detailCode, code) {
    ...
    /**
    * Constructs a <code>StatusTypeV2</code> from a plain JavaScript object, optionally creating a new instance.
    * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
    * @param {Object} data The plain JavaScript object bearing properties of interest.
    * @param {module:model/StatusTypeV2} obj Optional instance to populate.
    * @return {module:model/StatusTypeV2} The populated <code>StatusTypeV2</code> instance.
    */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new StatusTypeV2();
            ...
            if (data.hasOwnProperty('actionRequiredBy')) {
                obj['actionRequiredBy'] = StatusTypeV2ActionRequiredBy.constructFromObject(data['actionRequiredBy']);
            }
            if (data.hasOwnProperty('stage')) {
                obj['stage'] = StatusTypeV2Stage.constructFromObject(data['stage']);
            }
            if (data.hasOwnProperty('state')) {
                obj['state'] = StatusTypeV2Stage.constructFromObject(data['state']);
            }
            ...
            if (data.hasOwnProperty('detailCode')) {
                obj['detailCode'] = ApiClient.convertToType(data['detailCode'], 'String');
            }
    ...
    */
    'isClosed' = undefined;
    /**
    * @member {module:model/StatusTypeV2ActionRequiredBy} actionRequiredBy
    */
    'actionRequiredBy' = undefined;
    /**
    * @member {module:model/StatusTypeV2Stage} stage
    */
    'stage' = undefined;
    /**
    * @member {module:model/StatusTypeV2Stage} state
    */
    'state' = undefined;
    /**
