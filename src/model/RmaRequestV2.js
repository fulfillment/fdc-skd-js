...
import Paths1orderspostrequestBodycontentapplication1jsonschemapropertiesrecipient from './Paths1orderspostrequestBodycontentapplication1jsonschemapropertiesrecipient';
import ReturnsItems from './ReturnsItems';
...
* @version 2.0
*/
export default class RmaRequestV2 {
    /**
    * Constructs a new <code>RmaRequestV2</code>.
    * @alias module:model/RmaRequestV2
    * @class
    * @param items {Array.<module:model/ReturnsItems>} 
    * @param recipient {module:model/Paths1orderspostrequestBodycontentapplication1jsonschemapropertiesrecipient} 
    ...
    */
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('items')) {
                obj['items'] = ApiClient.convertToType(data['items'], [ReturnsItems]);
            }
            if (data.hasOwnProperty('recipient')) {
                obj['recipient'] = Paths1orderspostrequestBodycontentapplication1jsonschemapropertiesrecipient.constructFromObject(data['recipient']);
            }
    ...
    /**
    * @member {Array.<module:model/ReturnsItems>} items
    */
    'items' = undefined;
    /**
    * @member {module:model/Paths1orderspostrequestBodycontentapplication1jsonschemapropertiesrecipient} recipient
    */
    'recipient' = undefined;
    /**
