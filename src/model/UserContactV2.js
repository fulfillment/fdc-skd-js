...
import UserContactV21 from './UserContactV21';
import UserContactV21Merchant from './UserContactV21Merchant';

/**
* The UserContactV2 model module.
* @module model/UserContactV2
* @version 2.0
*/
export default class UserContactV2 {
    /**
    * Constructs a new <code>UserContactV2</code>.
    * @alias module:model/UserContactV2
    * @class
    * @param id {Number} 
    */
    ...
    /**
    * Constructs a <code>UserContactV2</code> from a plain JavaScript object, optionally creating a new instance.
    * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
    * @param {Object} data The plain JavaScript object bearing properties of interest.
    * @param {module:model/UserContactV2} obj Optional instance to populate.
    * @return {module:model/UserContactV2} The populated <code>UserContactV2</code> instance.
    */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new UserContactV2();
            ...
            if (data.hasOwnProperty('contactInfo')) {
                obj['contactInfo'] = UserContactV21.constructFromObject(data['contactInfo']);
            }
    ...
    */
    'apiKey' = undefined;
    /**
    * @member {module:model/UserContactV21} contactInfo
    */
