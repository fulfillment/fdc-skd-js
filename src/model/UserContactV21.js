...
import UserContactV21Merchant from './UserContactV21Merchant';

/**
* The UserContactV21 model module.
* @module model/UserContactV21
* @version 2.0
*/
export default class UserContactV21 {
    /**
    * Constructs a new <code>UserContactV21</code>.
    * @alias module:model/UserContactV21
    * @class
    * @param id {Number} 
    */
    ...
    /**
    * Constructs a <code>UserContactV21</code> from a plain JavaScript object, optionally creating a new instance.
    * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
    * @param {Object} data The plain JavaScript object bearing properties of interest.
    * @param {module:model/UserContactV21} obj Optional instance to populate.
    * @return {module:model/UserContactV21} The populated <code>UserContactV21</code> instance.
    */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new UserContactV21();
            ...
            if (data.hasOwnProperty('contactInfo')) {
                obj['contactInfo'] = Paths1orderspostresponses201contentapplication1jsonschemapropertiesoriginalConsignee.constructFromObject(data['contactInfo']);
            }
            if (data.hasOwnProperty('merchant')) {
                obj['merchant'] = UserContactV21Merchant.constructFromObject(data['merchant']);
            }
            ...
            if (data.hasOwnProperty('updatedBy')) {
                obj['updatedBy'] = ApiClient.convertToType(data['updatedBy'], 'Date');
            }
            if (data.hasOwnProperty('status')) {
                obj['status'] = ApiClient.convertToType(data['status'], 'Boolean');
            }
            if (data.hasOwnProperty('deptLeader')) {
                obj['deptLeader'] = ApiClient.convertToType(data['deptLeader'], 'Boolean');
            }
    ...
    */
    'apiKey' = undefined;
    /**
    * @member {module:model/Paths1orderspostresponses201contentapplication1jsonschemapropertiesoriginalConsignee} contactInfo
    */
    'contactInfo' = undefined;
    /**
    * @member {module:model/UserContactV21Merchant} merchant
    */
    'merchant' = undefined;
    /**
