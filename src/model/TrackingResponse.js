...
import Paths1trackgetresponses200contentapplication1jsonschemapropertiesorigin from './Paths1trackgetresponses200contentapplication1jsonschemapropertiesorigin';
import TrackingEventV2 from './TrackingEventV2';
...
export default class TrackingResponse {
    ...
    */
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('trackedEvents')) {
                obj['trackedEvents'] = ApiClient.convertToType(data['trackedEvents'], [TrackingEventV2]);
            }
            if (data.hasOwnProperty('fdcOrderId')) {
                obj['fdcOrderId'] = ApiClient.convertToType(data['fdcOrderId'], 'Number');
            }
            if (data.hasOwnProperty('firstTransitEvent')) {
                obj['firstTransitEvent'] = ApiClient.convertToType(data['firstTransitEvent'], 'Date');
            }
            if (data.hasOwnProperty('lastUpdatedDateTime')) {
                obj['lastUpdatedDateTime'] = ApiClient.convertToType(data['lastUpdatedDateTime'], 'Date');
            }
            if (data.hasOwnProperty('lastCheckedDateTime')) {
                obj['lastCheckedDateTime'] = ApiClient.convertToType(data['lastCheckedDateTime'], 'Date');
            }
            if (data.hasOwnProperty('firstCheckedDateTime')) {
                obj['firstCheckedDateTime'] = ApiClient.convertToType(data['firstCheckedDateTime'], 'Date');
            }
            if (data.hasOwnProperty('statusMessage')) {
                obj['statusMessage'] = ApiClient.convertToType(data['statusMessage'], 'String');
            }
            if (data.hasOwnProperty('statusCategoryCode')) {
                obj['statusCategoryCode'] = ApiClient.convertToType(data['statusCategoryCode'], 'Number');
            }
            ...
            if (data.hasOwnProperty('destination')) {
                obj['destination'] = Paths1trackgetresponses200contentapplication1jsonschemapropertiesorigin.constructFromObject(data['destination']);
            }
            if (data.hasOwnProperty('origin')) {
                obj['origin'] = Feature.constructFromObject(data['origin']);
            }
            if (data.hasOwnProperty('trackingNumber')) {
                obj['trackingNumber'] = TrackingNumberV2.constructFromObject(data['trackingNumber']);
            }
        }
        return obj;
    }
    ...
    /**
    * @member {Array.<module:model/TrackingEventV2>} trackedEvents
    */
    'trackedEvents' = undefined;
    /**
    * @member {Number} fdcOrderId
    */
    'fdcOrderId' = undefined;
    /**
    * @member {Date} firstTransitEvent
    */
    'firstTransitEvent' = undefined;
    /**
    * @member {Date} lastUpdatedDateTime
    */
    'lastUpdatedDateTime' = undefined;
    /**
    * @member {Date} lastCheckedDateTime
    */
    'lastCheckedDateTime' = undefined;
    /**
    * @member {Date} firstCheckedDateTime
    */
    'firstCheckedDateTime' = undefined;
    /**
    * @member {String} statusMessage
    */
    'statusMessage' = undefined;
    /**
    * @member {Number} statusCategoryCode
    */
    'statusCategoryCode' = undefined;
    /**
    ...
    */
    'status' = undefined;
    /**
    * @member {module:model/Paths1trackgetresponses200contentapplication1jsonschemapropertiesorigin} destination
    */
    'destination' = undefined;
    /**
    * @member {module:model/Feature} origin
    */
    'origin' = undefined;
    /**
    * @member {module:model/TrackingNumberV2} trackingNumber
    */
