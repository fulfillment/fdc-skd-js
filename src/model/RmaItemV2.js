...
import ReturnsArrayV2Item from './ReturnsArrayV2Item';
import ReturnsArrayV2NonRestockedReason from './ReturnsArrayV2NonRestockedReason';
...
* @version 2.0
*/
export default class RmaItemV2 {
    /**
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('nonRestockedReason')) {
                obj['nonRestockedReason'] = ReturnsArrayV2NonRestockedReason.constructFromObject(data['nonRestockedReason']);
            }
            ...
            if (data.hasOwnProperty('item')) {
                obj['item'] = ReturnsArrayV2Item.constructFromObject(data['item']);
            }
        }
        return obj;
    }
    ...
    */
    'id' = undefined;
    /**
    * @member {module:model/ReturnsArrayV2NonRestockedReason} nonRestockedReason
    */
    'nonRestockedReason' = undefined;
    /**
    ...
    */
    'comments' = undefined;
    /**
    * @member {module:model/ReturnsArrayV2Item} item
    */
    'item' = undefined;
