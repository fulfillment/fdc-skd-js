...
export default class Geometry {
    ...
    * @param coordinates {module:model/ModelObject} 
    */
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('coordinates')) {
                obj['coordinates'] = ApiClient.convertToType(data['coordinates'], ModelObject);
            }
        }
        return obj;
    }
    ...
    */
    'type' = undefined;
    /**
    * @member {module:model/ModelObject} coordinates
    */
