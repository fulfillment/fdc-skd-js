...
/**
* The OneOfAccessTokenRequestV2 model module.
* @module model/OneOfAccessTokenRequestV2
* @version 2.0
*/
export default class OneOfAccessTokenRequestV2 {
    /**
    * Constructs a new <code>OneOfAccessTokenRequestV2</code>.
    * @alias module:model/OneOfAccessTokenRequestV2
    * @class
    */
    ...
    /**
    * Constructs a <code>OneOfAccessTokenRequestV2</code> from a plain JavaScript object, optionally creating a new instance.
    * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
    * @param {Object} data The plain JavaScript object bearing properties of interest.
    * @param {module:model/OneOfAccessTokenRequestV2} obj Optional instance to populate.
    * @return {module:model/OneOfAccessTokenRequestV2} The populated <code>OneOfAccessTokenRequestV2</code> instance.
    */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new OneOfAccessTokenRequestV2();
