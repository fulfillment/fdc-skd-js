...
/**
* The ItemInventoryArrayV2Meta model module.
* @module model/ItemInventoryArrayV2Meta
* @version 2.0
*/
export default class ItemInventoryArrayV2Meta {
    /**
    * Constructs a new <code>ItemInventoryArrayV2Meta</code>.
    * @alias module:model/ItemInventoryArrayV2Meta
    * @class
    */
    ...
    /**
    * Constructs a <code>ItemInventoryArrayV2Meta</code> from a plain JavaScript object, optionally creating a new instance.
    * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
    * @param {Object} data The plain JavaScript object bearing properties of interest.
    * @param {module:model/ItemInventoryArrayV2Meta} obj Optional instance to populate.
    * @return {module:model/ItemInventoryArrayV2Meta} The populated <code>ItemInventoryArrayV2Meta</code> instance.
    */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ItemInventoryArrayV2Meta();
                        
            
            if (data.hasOwnProperty('pagination')) {
                obj['pagination'] = PaginationV2.constructFromObject(data['pagination']);
            }
        }
        return obj;
    }
    ...
    /**
    * @member {module:model/PaginationV2} pagination
    */
