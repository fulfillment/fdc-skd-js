...
import ReturnsArrayV2Meta from './ReturnsArrayV2Meta';
...
* @version 2.0
*/
export default class ReturnsArrayV2 {
    /**
    ...
    */
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('meta')) {
                obj['meta'] = ReturnsArrayV2Meta.constructFromObject(data['meta']);
            }
    ...
    /**
    * @member {module:model/ReturnsArrayV2Meta} meta
    */
    'meta' = undefined;
    /**
