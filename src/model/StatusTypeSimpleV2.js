...
import OrdersidstatusStatus from './OrdersidstatusStatus';

/**
* The StatusTypeSimpleV2 model module.
* @module model/StatusTypeSimpleV2
* @version 2.0
*/
export default class StatusTypeSimpleV2 {
    /**
    * Constructs a new <code>StatusTypeSimpleV2</code>.
    * @alias module:model/StatusTypeSimpleV2
    * @class
    * @param reason {String} Human-readable description
    * @param status {module:model/OrdersidstatusStatus} 
    */
    ...
    /**
    * Constructs a <code>StatusTypeSimpleV2</code> from a plain JavaScript object, optionally creating a new instance.
    * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
    * @param {Object} data The plain JavaScript object bearing properties of interest.
    * @param {module:model/StatusTypeSimpleV2} obj Optional instance to populate.
    * @return {module:model/StatusTypeSimpleV2} The populated <code>StatusTypeSimpleV2</code> instance.
    */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new StatusTypeSimpleV2();
            ...
            if (data.hasOwnProperty('status')) {
                obj['status'] = OrdersidstatusStatus.constructFromObject(data['status']);
            }
        }
        return obj;
    }
    ...
    */
    'reason' = undefined;
    /**
    * @member {module:model/OrdersidstatusStatus} status
    */
    'status' = undefined;
