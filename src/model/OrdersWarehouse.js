...
/**
* The OrdersWarehouse model module.
* @module model/OrdersWarehouse
* @version 2.0
*/
export default class OrdersWarehouse {
    /**
    * Constructs a new <code>OrdersWarehouse</code>.
    ...
    * @alias module:model/OrdersWarehouse
    * @class
    */
    ...
    /**
    * Constructs a <code>OrdersWarehouse</code> from a plain JavaScript object, optionally creating a new instance.
    * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
    * @param {Object} data The plain JavaScript object bearing properties of interest.
    * @param {module:model/OrdersWarehouse} obj Optional instance to populate.
    * @return {module:model/OrdersWarehouse} The populated <code>OrdersWarehouse</code> instance.
    */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new OrdersWarehouse();
