...
/**
* The OrdersItems model module.
* @module model/OrdersItems
* @version 2.0
*/
export default class OrdersItems {
    /**
    * Constructs a new <code>OrdersItems</code>.
    * @alias module:model/OrdersItems
    * @class
    * @param quantity {Number} 
    * @param sku {String} 
    * @param declaredValue {String} Using USD, a per unit value of a single SKU. If your declaring a kit this is the sum total for a single kit. In both scenarios we will multiply the `declaredValue` against the `quantity` for customs declaration.
    */

    constructor(quantity, sku, declaredValue) {
    ...
    /**
    * Constructs a <code>OrdersItems</code> from a plain JavaScript object, optionally creating a new instance.
    * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
    * @param {Object} data The plain JavaScript object bearing properties of interest.
    * @param {module:model/OrdersItems} obj Optional instance to populate.
    * @return {module:model/OrdersItems} The populated <code>OrdersItems</code> instance.
    */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new OrdersItems();
            ...
            if (data.hasOwnProperty('declaredValue')) {
                obj['declaredValue'] = ApiClient.convertToType(data['declaredValue'], 'String');
            }
        }
        return obj;
    }
