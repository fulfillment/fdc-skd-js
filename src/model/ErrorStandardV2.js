...
/**
* The ErrorStandardV2 model module.
* @module model/ErrorStandardV2
* @version 2.0
*/
export default class ErrorStandardV2 {
    /**
    * Constructs a new <code>ErrorStandardV2</code>.
    * @alias module:model/ErrorStandardV2
    * @class
    */
    ...
    /**
    * Constructs a <code>ErrorStandardV2</code> from a plain JavaScript object, optionally creating a new instance.
    * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
    * @param {Object} data The plain JavaScript object bearing properties of interest.
    * @param {module:model/ErrorStandardV2} obj Optional instance to populate.
    * @return {module:model/ErrorStandardV2} The populated <code>ErrorStandardV2</code> instance.
    */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ErrorStandardV2();
