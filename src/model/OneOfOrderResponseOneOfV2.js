...
/**
* The OneOfOrderResponseOneOfV2 model module.
* @module model/OneOfOrderResponseOneOfV2
* @version 2.0
*/
export default class OneOfOrderResponseOneOfV2 {
    /**
    * Constructs a new <code>OneOfOrderResponseOneOfV2</code>.
    * @alias module:model/OneOfOrderResponseOneOfV2
    * @class
    */
    ...
    /**
    * Constructs a <code>OneOfOrderResponseOneOfV2</code> from a plain JavaScript object, optionally creating a new instance.
    * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
    * @param {Object} data The plain JavaScript object bearing properties of interest.
    * @param {module:model/OneOfOrderResponseOneOfV2} obj Optional instance to populate.
    * @return {module:model/OneOfOrderResponseOneOfV2} The populated <code>OneOfOrderResponseOneOfV2</code> instance.
    */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new OneOfOrderResponseOneOfV2();
