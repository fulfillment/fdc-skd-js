...
/**
* The ReturnsArrayV2Item model module.
* @module model/ReturnsArrayV2Item
* @version 2.0
*/
export default class ReturnsArrayV2Item {
    /**
    * Constructs a new <code>ReturnsArrayV2Item</code>.
    * @alias module:model/ReturnsArrayV2Item
    * @class
    */
    ...
    /**
    * Constructs a <code>ReturnsArrayV2Item</code> from a plain JavaScript object, optionally creating a new instance.
    * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
    * @param {Object} data The plain JavaScript object bearing properties of interest.
    * @param {module:model/ReturnsArrayV2Item} obj Optional instance to populate.
    * @return {module:model/ReturnsArrayV2Item} The populated <code>ReturnsArrayV2Item</code> instance.
    */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ReturnsArrayV2Item();
