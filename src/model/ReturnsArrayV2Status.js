...
/**
* The ReturnsArrayV2Status model module.
* @module model/ReturnsArrayV2Status
* @version 2.0
*/
export default class ReturnsArrayV2Status {
    /**
    * Constructs a new <code>ReturnsArrayV2Status</code>.
    * @alias module:model/ReturnsArrayV2Status
    * @class
    * @param id {Number} 
    * @param title {String} 
    */
    ...
    /**
    * Constructs a <code>ReturnsArrayV2Status</code> from a plain JavaScript object, optionally creating a new instance.
    * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
    * @param {Object} data The plain JavaScript object bearing properties of interest.
    * @param {module:model/ReturnsArrayV2Status} obj Optional instance to populate.
    * @return {module:model/ReturnsArrayV2Status} The populated <code>ReturnsArrayV2Status</code> instance.
    */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ReturnsArrayV2Status();
