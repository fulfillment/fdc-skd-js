...
import ItemInventoryArrayV2QuantityTotal from './ItemInventoryArrayV2QuantityTotal';

/**
* The ItemInventoryArrayV2Quantity model module.
* @module model/ItemInventoryArrayV2Quantity
* @version 2.0
*/
export default class ItemInventoryArrayV2Quantity {
    /**
    * Constructs a new <code>ItemInventoryArrayV2Quantity</code>.
    * @alias module:model/ItemInventoryArrayV2Quantity
    * @class
    */
    ...
    /**
    * Constructs a <code>ItemInventoryArrayV2Quantity</code> from a plain JavaScript object, optionally creating a new instance.
    * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
    * @param {Object} data The plain JavaScript object bearing properties of interest.
    * @param {module:model/ItemInventoryArrayV2Quantity} obj Optional instance to populate.
    * @return {module:model/ItemInventoryArrayV2Quantity} The populated <code>ItemInventoryArrayV2Quantity</code> instance.
    */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ItemInventoryArrayV2Quantity();
                        
            
            if (data.hasOwnProperty('total')) {
                obj['total'] = ItemInventoryArrayV2QuantityTotal.constructFromObject(data['total']);
            }
        }
        return obj;
    }
    ...
    /**
    * @member {module:model/ItemInventoryArrayV2QuantityTotal} total
    */
    'total' = undefined;
