...
/**
* The ReturnsArrayV2Meta model module.
* @module model/ReturnsArrayV2Meta
* @version 2.0
*/
export default class ReturnsArrayV2Meta {
    /**
    * Constructs a new <code>ReturnsArrayV2Meta</code>.
    * @alias module:model/ReturnsArrayV2Meta
    * @class
    */
    ...
    /**
    * Constructs a <code>ReturnsArrayV2Meta</code> from a plain JavaScript object, optionally creating a new instance.
    * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
    * @param {Object} data The plain JavaScript object bearing properties of interest.
    * @param {module:model/ReturnsArrayV2Meta} obj Optional instance to populate.
    * @return {module:model/ReturnsArrayV2Meta} The populated <code>ReturnsArrayV2Meta</code> instance.
    */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ReturnsArrayV2Meta();
