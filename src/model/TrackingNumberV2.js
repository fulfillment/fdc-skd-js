...
/**
* The TrackingNumberV2 model module.
* @module model/TrackingNumberV2
* @version 2.0
*/
export default class TrackingNumberV2 {
    /**
    * Constructs a new <code>TrackingNumberV2</code>.
    * @alias module:model/TrackingNumberV2
    * @class
    */
    ...
    /**
    * Constructs a <code>TrackingNumberV2</code> from a plain JavaScript object, optionally creating a new instance.
    * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
    * @param {Object} data The plain JavaScript object bearing properties of interest.
    * @param {module:model/TrackingNumberV2} obj Optional instance to populate.
    * @return {module:model/TrackingNumberV2} The populated <code>TrackingNumberV2</code> instance.
    */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new TrackingNumberV2();
                        
            
            if (data.hasOwnProperty('carrier')) {
                obj['carrier'] = UserV2.constructFromObject(data['carrier']);
            }
            if (data.hasOwnProperty('barcodeScanValue')) {
                obj['barcodeScanValue'] = ApiClient.convertToType(data['barcodeScanValue'], 'String');
            }
    ...
    /**
    * @member {module:model/UserV2} carrier
    */
    'carrier' = undefined;
    /**
    * The computer readable alternative to the human readable
    * @member {String} barcodeScanValue
    */
    'barcodeScanValue' = undefined;
    /**
