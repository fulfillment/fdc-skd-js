...
/**
* The TrackingEventV2 model module.
* @module model/TrackingEventV2
* @version 2.0
*/
export default class TrackingEventV2 {
    /**
    * Constructs a new <code>TrackingEventV2</code>.
    * @alias module:model/TrackingEventV2
    * @class
    */
    ...
    /**
    * Constructs a <code>TrackingEventV2</code> from a plain JavaScript object, optionally creating a new instance.
    * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
    * @param {Object} data The plain JavaScript object bearing properties of interest.
    * @param {module:model/TrackingEventV2} obj Optional instance to populate.
    * @return {module:model/TrackingEventV2} The populated <code>TrackingEventV2</code> instance.
    */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new TrackingEventV2();
            ...
            if (data.hasOwnProperty('eventLocation')) {
                obj['eventLocation'] = Paths1trackgetresponses200contentapplication1jsonschemapropertiesorigin.constructFromObject(data['eventLocation']);
            }
            if (data.hasOwnProperty('eventDateTime')) {
                obj['eventDateTime'] = ApiClient.convertToType(data['eventDateTime'], 'Date');
            }
            if (data.hasOwnProperty('eventCategoryCode')) {
                obj['eventCategoryCode'] = ApiClient.convertToType(data['eventCategoryCode'], 'Number');
            }
    ...
    /**
    * @member {module:model/TrackingEventV2.EventSourceEnum} eventSource
    */
    'eventSource' = undefined;
    /**
    * @member {module:model/Paths1trackgetresponses200contentapplication1jsonschemapropertiesorigin} eventLocation
    */
    ...
    */
    ...
    /**
    * @member {Number} eventCategoryCode
    */
    'eventCategoryCode' = undefined;
    /**
