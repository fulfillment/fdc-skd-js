...
/**
* The IsoCountryV2 model module.
* @module model/IsoCountryV2
* @version 2.0
*/
export default class IsoCountryV2 {
    /**
    * Constructs a new <code>IsoCountryV2</code>.
    * @alias module:model/IsoCountryV2
    * @class
    */
    ...
    /**
    * Constructs a <code>IsoCountryV2</code> from a plain JavaScript object, optionally creating a new instance.
    * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
    * @param {Object} data The plain JavaScript object bearing properties of interest.
    * @param {module:model/IsoCountryV2} obj Optional instance to populate.
    * @return {module:model/IsoCountryV2} The populated <code>IsoCountryV2</code> instance.
    */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new IsoCountryV2();
