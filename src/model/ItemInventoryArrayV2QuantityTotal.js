...
/**
* The ItemInventoryArrayV2QuantityTotal model module.
* @module model/ItemInventoryArrayV2QuantityTotal
* @version 2.0
*/
export default class ItemInventoryArrayV2QuantityTotal {
    /**
    * Constructs a new <code>ItemInventoryArrayV2QuantityTotal</code>.
    * @alias module:model/ItemInventoryArrayV2QuantityTotal
    * @class
    */
    ...
    /**
    * Constructs a <code>ItemInventoryArrayV2QuantityTotal</code> from a plain JavaScript object, optionally creating a new instance.
    * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
    * @param {Object} data The plain JavaScript object bearing properties of interest.
    * @param {module:model/ItemInventoryArrayV2QuantityTotal} obj Optional instance to populate.
    * @return {module:model/ItemInventoryArrayV2QuantityTotal} The populated <code>ItemInventoryArrayV2QuantityTotal</code> instance.
    */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ItemInventoryArrayV2QuantityTotal();
