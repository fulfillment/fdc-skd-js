...
/**
* The UserContactV21Merchant model module.
* @module model/UserContactV21Merchant
* @version 2.0
*/
export default class UserContactV21Merchant {
    /**
    * Constructs a new <code>UserContactV21Merchant</code>.
    * @alias module:model/UserContactV21Merchant
    * @class
    */
    ...
    /**
    * Constructs a <code>UserContactV21Merchant</code> from a plain JavaScript object, optionally creating a new instance.
    * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
    * @param {Object} data The plain JavaScript object bearing properties of interest.
    * @param {module:model/UserContactV21Merchant} obj Optional instance to populate.
    * @return {module:model/UserContactV21Merchant} The populated <code>UserContactV21Merchant</code> instance.
    */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new UserContactV21Merchant();
