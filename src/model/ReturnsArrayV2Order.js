...
/**
* The ReturnsArrayV2Order model module.
* @module model/ReturnsArrayV2Order
* @version 2.0
*/
export default class ReturnsArrayV2Order {
    /**
    * Constructs a new <code>ReturnsArrayV2Order</code>.
    * @alias module:model/ReturnsArrayV2Order
    * @class
    */
    ...
    /**
    * Constructs a <code>ReturnsArrayV2Order</code> from a plain JavaScript object, optionally creating a new instance.
    * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
    * @param {Object} data The plain JavaScript object bearing properties of interest.
    * @param {module:model/ReturnsArrayV2Order} obj Optional instance to populate.
    * @return {module:model/ReturnsArrayV2Order} The populated <code>ReturnsArrayV2Order</code> instance.
    */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ReturnsArrayV2Order();
