...
/**
* The AccessTokenResponseV2 model module.
* @module model/AccessTokenResponseV2
* @version 2.0
*/
export default class AccessTokenResponseV2 {
    /**
    * Constructs a new <code>AccessTokenResponseV2</code>.
    * @alias module:model/AccessTokenResponseV2
    * @class
    */
    ...
    /**
    * Constructs a <code>AccessTokenResponseV2</code> from a plain JavaScript object, optionally creating a new instance.
    * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
    * @param {Object} data The plain JavaScript object bearing properties of interest.
    * @param {module:model/AccessTokenResponseV2} obj Optional instance to populate.
    * @return {module:model/AccessTokenResponseV2} The populated <code>AccessTokenResponseV2</code> instance.
    */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new AccessTokenResponseV2();
