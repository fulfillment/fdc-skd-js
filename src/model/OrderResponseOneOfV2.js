...
* @version 2.0
*/
export default class OrderResponseOneOfV2 {
    /**
    ...
    */
    ...
    constructor() {
        ...
        OneOfOrderResponseOneOfV2.call(this);
    ...
    */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new OrderResponseOneOfV2();
    ...
    // Implement OneOfOrderResponseOneOfV2 interface:
