...
/**
* The ItemInventoryArrayV2Item model module.
* @module model/ItemInventoryArrayV2Item
* @version 2.0
*/
export default class ItemInventoryArrayV2Item {
    /**
    * Constructs a new <code>ItemInventoryArrayV2Item</code>.
    * Item this inventory data is based on
    * @alias module:model/ItemInventoryArrayV2Item
    * @class
    */
    ...
    /**
    * Constructs a <code>ItemInventoryArrayV2Item</code> from a plain JavaScript object, optionally creating a new instance.
    * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
    * @param {Object} data The plain JavaScript object bearing properties of interest.
    * @param {module:model/ItemInventoryArrayV2Item} obj Optional instance to populate.
    * @return {module:model/ItemInventoryArrayV2Item} The populated <code>ItemInventoryArrayV2Item</code> instance.
    */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ItemInventoryArrayV2Item();
