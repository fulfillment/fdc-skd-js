...
import ItemInventoryArrayV2Meta from './ItemInventoryArrayV2Meta';
import ItemInventoryV2 from './ItemInventoryV2';

/**
* The ItemInventoryArrayV2 model module.
* @module model/ItemInventoryArrayV2
* @version 2.0
*/
export default class ItemInventoryArrayV2 {
    /**
    * Constructs a new <code>ItemInventoryArrayV2</code>.
    * @alias module:model/ItemInventoryArrayV2
    * @class
    */
    ...
    /**
    * Constructs a <code>ItemInventoryArrayV2</code> from a plain JavaScript object, optionally creating a new instance.
    * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
    * @param {Object} data The plain JavaScript object bearing properties of interest.
    * @param {module:model/ItemInventoryArrayV2} obj Optional instance to populate.
    * @return {module:model/ItemInventoryArrayV2} The populated <code>ItemInventoryArrayV2</code> instance.
    */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ItemInventoryArrayV2();
                        
            
            if (data.hasOwnProperty('meta')) {
                obj['meta'] = ItemInventoryArrayV2Meta.constructFromObject(data['meta']);
            }
            if (data.hasOwnProperty('data')) {
                obj['data'] = ApiClient.convertToType(data['data'], [ItemInventoryV2]);
            }
        }
        return obj;
    }
    ...
    /**
    * @member {module:model/ItemInventoryArrayV2Meta} meta
    */
    'meta' = undefined;
    /**
    * @member {Array.<module:model/ItemInventoryV2>} data
    */
    'data' = undefined;
