...
/**
* The StatusTypeV2Stage model module.
* @module model/StatusTypeV2Stage
* @version 2.0
*/
export default class StatusTypeV2Stage {
    /**
    * Constructs a new <code>StatusTypeV2Stage</code>.
    * @alias module:model/StatusTypeV2Stage
    * @class
    */
    ...
    /**
    * Constructs a <code>StatusTypeV2Stage</code> from a plain JavaScript object, optionally creating a new instance.
    * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
    * @param {Object} data The plain JavaScript object bearing properties of interest.
    * @param {module:model/StatusTypeV2Stage} obj Optional instance to populate.
    * @return {module:model/StatusTypeV2Stage} The populated <code>StatusTypeV2Stage</code> instance.
    */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new StatusTypeV2Stage();
