...
/**
* The AccessTokenRequestV2 model module.
* @module model/AccessTokenRequestV2
* @version 2.0
*/
export default class AccessTokenRequestV2 {
    /**
    * Constructs a new <code>AccessTokenRequestV2</code>.
    * @alias module:model/AccessTokenRequestV2
    * @class
    */

    constructor() {
        
        OneOfAccessTokenRequestV2.call(this);
        
    }

    /**
    * Constructs a <code>AccessTokenRequestV2</code> from a plain JavaScript object, optionally creating a new instance.
    * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
    * @param {Object} data The plain JavaScript object bearing properties of interest.
    * @param {module:model/AccessTokenRequestV2} obj Optional instance to populate.
    * @return {module:model/AccessTokenRequestV2} The populated <code>AccessTokenRequestV2</code> instance.
    */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new AccessTokenRequestV2();
    ...
    // Implement OneOfAccessTokenRequestV2 interface:
