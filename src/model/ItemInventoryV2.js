...
import ItemInventoryArrayV2Item from './ItemInventoryArrayV2Item';
import ItemInventoryArrayV2Merchant from './ItemInventoryArrayV2Merchant';
import ItemInventoryArrayV2Quantity from './ItemInventoryArrayV2Quantity';

/**
* The ItemInventoryV2 model module.
* @module model/ItemInventoryV2
* @version 2.0
*/
export default class ItemInventoryV2 {
    /**
    * Constructs a new <code>ItemInventoryV2</code>.
    * @alias module:model/ItemInventoryV2
    * @class
    */
    ...
    /**
    * Constructs a <code>ItemInventoryV2</code> from a plain JavaScript object, optionally creating a new instance.
    * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
    * @param {Object} data The plain JavaScript object bearing properties of interest.
    * @param {module:model/ItemInventoryV2} obj Optional instance to populate.
    * @return {module:model/ItemInventoryV2} The populated <code>ItemInventoryV2</code> instance.
    */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ItemInventoryV2();
                        
            
            if (data.hasOwnProperty('quantity')) {
                obj['quantity'] = ItemInventoryArrayV2Quantity.constructFromObject(data['quantity']);
            }
            if (data.hasOwnProperty('merchant')) {
                obj['merchant'] = ItemInventoryArrayV2Merchant.constructFromObject(data['merchant']);
            }
            if (data.hasOwnProperty('item')) {
                obj['item'] = ItemInventoryArrayV2Item.constructFromObject(data['item']);
            }
        }
        return obj;
    }
    ...
    /**
    * @member {module:model/ItemInventoryArrayV2Quantity} quantity
    */
    'quantity' = undefined;
    /**
    * @member {module:model/ItemInventoryArrayV2Merchant} merchant
    */
    'merchant' = undefined;
    /**
    * @member {module:model/ItemInventoryArrayV2Item} item
    */
    'item' = undefined;
