...
/**
* The ItemInventoryArrayV2Merchant model module.
* @module model/ItemInventoryArrayV2Merchant
* @version 2.0
*/
export default class ItemInventoryArrayV2Merchant {
    /**
    * Constructs a new <code>ItemInventoryArrayV2Merchant</code>.
    * Merchant that owns this item
    * @alias module:model/ItemInventoryArrayV2Merchant
    * @class
    */
    ...
    /**
    * Constructs a <code>ItemInventoryArrayV2Merchant</code> from a plain JavaScript object, optionally creating a new instance.
    * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
    * @param {Object} data The plain JavaScript object bearing properties of interest.
    * @param {module:model/ItemInventoryArrayV2Merchant} obj Optional instance to populate.
    * @return {module:model/ItemInventoryArrayV2Merchant} The populated <code>ItemInventoryArrayV2Merchant</code> instance.
    */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ItemInventoryArrayV2Merchant();
