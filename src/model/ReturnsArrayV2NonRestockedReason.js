...
/**
* The ReturnsArrayV2NonRestockedReason model module.
* @module model/ReturnsArrayV2NonRestockedReason
* @version 2.0
*/
export default class ReturnsArrayV2NonRestockedReason {
    /**
    * Constructs a new <code>ReturnsArrayV2NonRestockedReason</code>.
    * @alias module:model/ReturnsArrayV2NonRestockedReason
    * @class
    */
    ...
    /**
    * Constructs a <code>ReturnsArrayV2NonRestockedReason</code> from a plain JavaScript object, optionally creating a new instance.
    * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
    * @param {Object} data The plain JavaScript object bearing properties of interest.
    * @param {module:model/ReturnsArrayV2NonRestockedReason} obj Optional instance to populate.
    * @return {module:model/ReturnsArrayV2NonRestockedReason} The populated <code>ReturnsArrayV2NonRestockedReason</code> instance.
    */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ReturnsArrayV2NonRestockedReason();
