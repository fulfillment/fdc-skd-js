# fulfillmentcom_ap_iv2

FulfillmentcomApIv2 - JavaScript client for fulfillmentcom_ap_iv2
...
```shell
npm install fulfillmentcom_ap_iv2 --save
```
...
```javascript
var FulfillmentcomApIv2 = require('fulfillmentcom_ap_iv2');

var api = new FulfillmentcomApIv2.AuthApi()
var body = new FulfillmentcomApIv2.AccessTokenRequestV2(); // {AccessTokenRequestV2} Get an access token
...
## Documentation for Models
 ...
 - [FulfillmentcomApIv2.ConsigneeV21](docs/ConsigneeV21.md)
 ...
 - [FulfillmentcomApIv2.ItemInventoryArrayV2Item](docs/ItemInventoryArrayV2Item.md)
 - [FulfillmentcomApIv2.ItemInventoryArrayV2Merchant](docs/ItemInventoryArrayV2Merchant.md)
 - [FulfillmentcomApIv2.ItemInventoryArrayV2Meta](docs/ItemInventoryArrayV2Meta.md)
 - [FulfillmentcomApIv2.ItemInventoryArrayV2Quantity](docs/ItemInventoryArrayV2Quantity.md)
 - [FulfillmentcomApIv2.ItemInventoryArrayV2QuantityTotal](docs/ItemInventoryArrayV2QuantityTotal.md)
 - [FulfillmentcomApIv2.ItemInventoryV2](docs/ItemInventoryV2.md)
 - [FulfillmentcomApIv2.MerchantV2](docs/MerchantV2.md)
 - [FulfillmentcomApIv2.OneOfAccessTokenRequestV2](docs/OneOfAccessTokenRequestV2.md)
 - [FulfillmentcomApIv2.OneOfGeometryCoordinates](docs/OneOfGeometryCoordinates.md)
 - [FulfillmentcomApIv2.OneOfOrderResponseOneOfV2](docs/OneOfOrderResponseOneOfV2.md)
 ...
 - [FulfillmentcomApIv2.OrdersItems](docs/OrdersItems.md)
 - [FulfillmentcomApIv2.OrdersWarehouse](docs/OrdersWarehouse.md)
 - [FulfillmentcomApIv2.OrdersidstatusStatus](docs/OrdersidstatusStatus.md)
 ...
 - [FulfillmentcomApIv2.ReturnsArrayV2Item](docs/ReturnsArrayV2Item.md)
 - [FulfillmentcomApIv2.ReturnsArrayV2Meta](docs/ReturnsArrayV2Meta.md)
 - [FulfillmentcomApIv2.ReturnsArrayV2NonRestockedReason](docs/ReturnsArrayV2NonRestockedReason.md)
 - [FulfillmentcomApIv2.ReturnsArrayV2Order](docs/ReturnsArrayV2Order.md)
 - [FulfillmentcomApIv2.ReturnsArrayV2Status](docs/ReturnsArrayV2Status.md)
 - [FulfillmentcomApIv2.ReturnsItems](docs/ReturnsItems.md)
 ...
 - [FulfillmentcomApIv2.UserContactV21](docs/UserContactV21.md)
 - [FulfillmentcomApIv2.UserContactV21Merchant](docs/UserContactV21Merchant.md)
