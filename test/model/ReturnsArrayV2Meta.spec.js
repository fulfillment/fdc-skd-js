...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new fulfillmentApiV2.ReturnsArrayV2Meta();
  });
  ...
  describe('ReturnsArrayV2Meta', function() {
    it('should create an instance of ReturnsArrayV2Meta', function() {
      ...
      //var instane = new fulfillmentApiV2.ReturnsArrayV2Meta();
      //expect(instance).to.be.a(fulfillmentApiV2.ReturnsArrayV2Meta);
    });
