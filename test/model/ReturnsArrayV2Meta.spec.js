...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FulfillmentcomApIv2.ReturnsArrayV2Meta();
  });
  ...
  describe('ReturnsArrayV2Meta', function() {
    it('should create an instance of ReturnsArrayV2Meta', function() {
      // uncomment below and update the code to test ReturnsArrayV2Meta
      //var instane = new FulfillmentcomApIv2.ReturnsArrayV2Meta();
      //expect(instance).to.be.a(FulfillmentcomApIv2.ReturnsArrayV2Meta);
    });
