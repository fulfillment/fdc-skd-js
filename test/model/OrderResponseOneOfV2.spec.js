...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new fulfillmentApiV2.OrderResponseOneOfV2();
  });
  ...
  describe('OrderResponseOneOfV2', function() {
    it('should create an instance of OrderResponseOneOfV2', function() {
      ...
      //var instane = new fulfillmentApiV2.OrderResponseOneOfV2();
      //expect(instance).to.be.a(fulfillmentApiV2.OrderResponseOneOfV2);
    });
