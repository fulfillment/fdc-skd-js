...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new fulfillmentApiV2.FeatureProperties();
  });
  ...
  describe('FeatureProperties', function() {
    it('should create an instance of FeatureProperties', function() {
      ...
      //var instane = new fulfillmentApiV2.FeatureProperties();
      //expect(instance).to.be.a(fulfillmentApiV2.FeatureProperties);
    });
