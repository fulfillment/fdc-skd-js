...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new fulfillmentApiV2.StatusTypeSimpleV2();
  });
  ...
  describe('StatusTypeSimpleV2', function() {
    it('should create an instance of StatusTypeSimpleV2', function() {
      ...
      //var instane = new fulfillmentApiV2.StatusTypeSimpleV2();
      //expect(instance).to.be.a(fulfillmentApiV2.StatusTypeSimpleV2);
    });
