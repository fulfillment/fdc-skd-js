...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FulfillmentcomApIv2.ConsigneeV2();
  });
  ...
  describe('ConsigneeV2', function() {
    it('should create an instance of ConsigneeV2', function() {
      // uncomment below and update the code to test ConsigneeV2
      //var instane = new FulfillmentcomApIv2.ConsigneeV2();
      //expect(instance).to.be.a(FulfillmentcomApIv2.ConsigneeV2);
    });
