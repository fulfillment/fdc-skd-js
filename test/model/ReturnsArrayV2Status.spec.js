...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new fulfillmentApiV2.ReturnsArrayV2Status();
  });
  ...
  describe('ReturnsArrayV2Status', function() {
    it('should create an instance of ReturnsArrayV2Status', function() {
      ...
      //var instane = new fulfillmentApiV2.ReturnsArrayV2Status();
      //expect(instance).to.be.a(fulfillmentApiV2.ReturnsArrayV2Status);
    });
