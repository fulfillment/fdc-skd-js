...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FulfillmentcomApIv2.ReturnsArrayV2Status();
  });
  ...
  describe('ReturnsArrayV2Status', function() {
    it('should create an instance of ReturnsArrayV2Status', function() {
      // uncomment below and update the code to test ReturnsArrayV2Status
      //var instane = new FulfillmentcomApIv2.ReturnsArrayV2Status();
      //expect(instance).to.be.a(FulfillmentcomApIv2.ReturnsArrayV2Status);
    });
