...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FulfillmentcomApIv2.AccessTokenRequestV2();
  });
  ...
  describe('AccessTokenRequestV2', function() {
    it('should create an instance of AccessTokenRequestV2', function() {
      // uncomment below and update the code to test AccessTokenRequestV2
      //var instane = new FulfillmentcomApIv2.AccessTokenRequestV2();
      //expect(instance).to.be.a(FulfillmentcomApIv2.AccessTokenRequestV2);
    });
