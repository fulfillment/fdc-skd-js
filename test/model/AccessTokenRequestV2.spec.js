...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new fulfillmentApiV2.AccessTokenRequestV2();
  });
  ...
  describe('AccessTokenRequestV2', function() {
    it('should create an instance of AccessTokenRequestV2', function() {
      ...
      //var instane = new fulfillmentApiV2.AccessTokenRequestV2();
      //expect(instance).to.be.a(fulfillmentApiV2.AccessTokenRequestV2);
    });
