...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FulfillmentcomApIv2.OrdersApi();
  });
  ...
  describe('OrdersApi', function() {
    describe('deleteOrdersId', function() {
      it('should call deleteOrdersId successfully', function(done) {
        //uncomment below and update the code to test deleteOrdersId
        //instance.deleteOrdersId(function(error) {
